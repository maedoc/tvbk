...
struct zerlaut_adaptation_second_order {
  static constexpr uint32_t num_svar = 8, num_parm = 50, num_cvar = 1;

  // Parameters match first order exactly in layout
  static constexpr const char
      *const parms = "g_L,E_L_e,E_L_i,C_m,b_e,a_e,b_i,a_i,tau_w_e,tau_w_i,"
                     "E_e,E_i,Q_e,Q_i,tau_e,tau_i,"
                     "N_tot,p_connect_e,p_connect_i,g,K_ext_e,K_ext_i,"
                     "external_input_ex_ex,external_input_ex_in,external_input_"
                     "in_ex,external_"
                     "input_in_in,"
                     "tau_OU,weight_noise,S_i,T,"
                     "P_e,P_i",
             *const name = "zerlaut_adaptation_second_order",
             *const svars = "E,I,C_ee,C_ei,C_ii,W_e,W_i,ou_drift",
             *const svar_ranges =
                 "E=[0.001, 0.25];I=[0.001, 0.25];C_ee=[0.0, "
                 "0.0005];C_ei=[-0.0005, 0.0005];C_ii=[0.0, 0.0005];W_e=[0.0, "
                 "200.0];W_i=[0.0, 0.0];ou_drift=[0.0, 0.0]",
             *const voi = "E";
  static constexpr float default_parms[50] = {
      ...
      -0.036592528f,  0.0074374875f, 0.012650647f,   -0.040721613f,
